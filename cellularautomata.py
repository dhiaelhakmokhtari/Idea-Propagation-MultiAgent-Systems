...
def SimulateCA(cellautomaton0: np.ndarray, f, neighborhood=Moore(1), duration: int = 500) -> list:
...
def ShowSimulation(simulation: list, cellcolors: dict[tuple, str], figheight: int = 5, delay: int = 500):
